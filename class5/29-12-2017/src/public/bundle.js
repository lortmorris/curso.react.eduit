  ...
  _createClass(AddForm, [{
    ...
    value: function onSubmitHandler(evt) {
      ...
      if (this.props.listId) {
        this.props.dispatch((0, _actions.AddItem)(this.props.listId, this.state.value));
        (0, _client2.default)({
          method: 'put',
          url: 'http://localhost:5000/addtodoitem',
          params: (0, _actions.AddItem)(this.props.listId, this.state.value)
        });
      } else {
        this.props.dispatch((0, _actions.AddNewTodosList)(this.state.value));
        (0, _client2.default)({
          method: 'put',
          url: 'http://localhost:5000/addtodolist',
          params: (0, _actions.AddNewTodosList)(this.state.value)
        });
      }
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(11), __webpack_require__(35)(module)))
...
var _todosList = __webpack_require__(53);
...
var _todoitems = __webpack_require__(54);
...
var TodosList = function TodosList(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'div',
      null,
      _react2.default.createElement('input', { className: 'form-control', type: 'checkbox', checked: '' + (completed ? 'checked' : ''), onChange: function onChange() {} })
    )
  );
};
...
var TodoItem = function (_React$Component) {
  ...
  function TodoItem(props) {
    ...
    _this.toggleItemHandler = _this.toggleItemHandler.bind(_this);
    return _this;
  }

  _createClass(TodoItem, [{
    key: 'toggleItemHandler',
    value: function toggleItemHandler() {
      this.props.dispatch((0, _actions.ToggleItem)(this.props.listId, this.props.id));
    }
  }, {
    key: 'removeItemHandler',
    value: function removeItemHandler() {
      this.props.dispatch((0, _actions.RemoveItem)(this.props.listId, this.props.id));
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        'li',
        { className: 'list-group-item ' + (completed ? 'list-group-item-success' : ''), onClick: this.toggleItemHandler },
        _react2.default.createElement(
          'strong',
          null,
          name
...
var request = function request(params) {
  return _axios2.default[params.method || 'get'](params.url, params.params).then(function (response) {
    return response;
  }).catch(function (err) {
