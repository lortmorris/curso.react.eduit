...
_reducers.store.subscribe(function () {
  return console.info(_reducers.store.getState());
});
_reducers.store.dispatch((0, _actions.createTodoList)('my first list'));
_reducers.store.dispatch((0, _actions.createTodoList)('my second list'));
_reducers.store.dispatch((0, _actions.removeTodoList)(0));
_reducers.store.dispatch((0, _actions.toggleList)(1));
_reducers.store.dispatch((0, _actions.toggleList)(1));
_reducers.store.dispatch((0, _actions.addTodo)(1, 'My first Todo'));
_reducers.store.dispatch((0, _actions.addTodo)(1, 'My second Todo'));
_reducers.store.dispatch((0, _actions.removeTodo)(1, 2));
_reducers.store.dispatch((0, _actions.toggleTodo)(1, 3));
